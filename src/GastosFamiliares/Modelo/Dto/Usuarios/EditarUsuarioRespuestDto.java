 ...
 */
public class EditarUsuarioRespuestDto {
private final String codigo;
    ...
    public EditarUsuarioRespuestDto(String codigo, String password, String nombre
            , String apellido, RolUsuarioEnum rol, String email) {
        this.codigo = codigo;
