 ...
 */
public class EditarUsuarioPeticionDto {
    ...
    public EditarUsuarioPeticionDto(String codigo, String password,
            String nombre, String apellido, RolUsuarioEnum rol, String email ) 
    {
